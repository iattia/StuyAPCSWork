public class QueenBoard {
   ...
   *                in which case the queen is added and all it's threatened
   *                positions are incremented.
   *                Only the squares in rows that are higher index than r should
   *                be marked as threatened.
   */
   ...
   * 
   * @precondition r and c are valid indices of the board array and there is a
   *               queen at position r,c
  ...
  /**
   * Find the first solution configuration possible for this size board. Start by
   * placing
   * the 1st queen in the top left corner, and each new queen in the next ROW.
   * When backtracking
   * move the previous queen to the next valid space. This means everyone will
   * generate the same
   * first solution.
   * 
   * @precondition: the board is filled with 0's (you don't try to solve an
   ...
   *         with zeros;
   *         returns true when the board is solveable, and leaves the board in a
   *         solved state
   */
  ...
  /**
   * Find all possible solutions to this size board. You must clear the board
